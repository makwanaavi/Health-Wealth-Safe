  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f5f5f5]">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left Sidebar */}
        {leftOpen && (
          <aside className=" bg-white flex flex-col w-100">
        ...
        {rightOpen && (
          <aside className="w-100 bg-white  flex flex-col">
            {/* Header */}
      ...
      <footer className="bg-[#e7e7e7] py-3 text-sm text-center text-black">
        Having trouble with video call? Call us at{" "}
        <a>+1 (877) 581-8810</a> (Available 24/7)
      </footer>
    </div>
  );
};
